...
add('大学要不要盲目合群', '为合群天天陪玩时间全耗掉，合不来不用勉强，时间花在值得的人事上', '/pitfalls', '合群 社交 朋友 室友 孤独', 'pitfall-4-0');
add('该不该借钱给同学', '刚认识就借钱的要留心，经常要不回还伤感情，只借你亏得起的数', '/pitfalls', '借钱 室友借钱 同学借钱 要不回 人情', 'pitfall-4-1');
add('生活费怎么规划', '别月初挥霍月底吃土，分周预算或用记账APP，心里有数不慌', '/pitfalls', '生活费 规划 记账 预算 月光 省钱 理财', 'pitfall-5-0');
add('会员卡该不该充', '奶茶理发健身爱推充值打折，想想去几次，冲动充值用不完退不了', '/pitfalls', '会员卡 充值 办卡 冲动消费', 'pitfall-5-1');
