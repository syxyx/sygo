...
lifeContent.dorm.apartments.forEach(apt => apt.majors.forEach(m => add(m, `住在${apt.name}，${apt.rooms}`, '/life', m + ' ' + apt.name + ' 宿舍 住在哪 住宿', 'life-dorm')));
...
// 社团
add('社团怎么选', '建议选1-2个真正感兴趣的，别报太多，报自己感兴趣的就行', '/life', '社团 学生会 活动 兴趣 游园会 招新', 'life-clubs');
...
add('四六级要早考', '大一不能报考四级，学校规定大二开始才能报，但英语别荒着，不然一年后全还给高中老师', '/pitfalls', '四六级 英语 四级 六级 考证 大一 报名', 'pitfall-1-0');
...
// ========== 公寓细节补充 ==========
add('乐山公寓长什么样', '机电城建男生集中区，4/6人间为主，下楼就是快递点', '/life', '乐山 照片 图片 样子 环境 实拍', 'life-dorm');
...
add('桃李公寓长什么样', '李子园老校区宿舍，6/8/10人间，在市中心商圈旁，出校门就是商业街', '/life', '李子园 桃李 照片 图片 样子 环境 实拍 老校区', 'life-dorm');
add('宿舍几人间', '乐山4/6人间、杏林6-12人套间、采芹4人间、泮水4人间、桃李公寓6/8/10人间', '/life', '几人间 几人 几人间寝 几人寝 上床下桌 独立卫浴 公共卫浴 套间', 'life-dorm');
add('哪栋宿舍最好', '采芹公寓全校条件最好，全新4人间上床下桌带电梯空调独立卫浴', '/life', '最好 最差 条件好 推荐 排名', 'life-dorm');
add('男生住哪个公寓', '机电城建类男生住乐山公寓，计算机/经管文法/体育男生住采芹公寓', '/life', '男生 住哪 住在哪 公寓 宿舍', 'life-dorm');
add('女生住哪个公寓', '经管文法类女生住泮水公寓，设计/理科师范类女生住采芹公寓', '/life', '女生 住哪 住在哪 公寓 宿舍', 'life-dorm');
...
// ========== 百问百答高频补充 ==========
add('大一可以考四级吗', '大一不能报考四级，学校规定大二开始才能报，但英语别荒着', '/qa', '四级 大一下 考的 能考 什么时候考 英语四级', 'qa-11');
