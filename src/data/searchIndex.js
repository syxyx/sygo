...
add('校园卡套餐坑', '9元无限流量卡往往限速或第二月涨价，办卡前问清合约期和到期资费', '/pitfalls', '校园卡 套餐 流量卡 电话卡 限速 涨价', 'pitfall-4-0');
add('游戏充值上头', '大学有了钱皮肤抽卡一冲动就氪金，给自己定额度别掏空钱包', '/pitfalls', '游戏 充值 氪金 皮肤 抽卡 上头', 'pitfall-4-2');
add('填问卷送手机是坑吗', '填问卷关注公众号送礼品多半套个人信息甚至办贷款，别交身份证银行卡', '/pitfalls', '填问卷 送手机 送耳机 个人信息 套路', 'pitfall-4-3');
add('军训防晒', '别觉得男生不用防晒，军训晒好几天会晒伤脱皮，买防水防晒霜勤补', '/pitfalls', '军训 防晒 晒伤 脱皮 男生', 'pitfall-5-0');
add('军训鞋磨脚', '军训鞋底硬码数不一定合适，提前备软鞋垫和创可贴', '/pitfalls', '军训 鞋 磨脚 起泡 鞋垫', 'pitfall-5-1');
add('军训会中暑吗', '每年都有人硬扛中暑晕倒，多喝水不舒服就打报告休息别逞强', '/pitfalls', '军训 中暑 晕倒 喝水 休息', 'pitfall-5-2');
add('社团要报几个', '百团大战别一口气报七八个，会费白交活动没去，挑1-2个真感兴趣的', '/pitfalls', '社团 报社团 百团大战 招新 几个', 'pitfall-6-0');
add('学生会值得进吗', '有些组织摆架子使唤新人干杂活，锻炼是真但别被当免费劳动力', '/pitfalls', '学生会 部门 组织 PUA 干杂活 新人', 'pitfall-6-1');
add('社团费要交多少', '正规社团会费就几十块，张口要一两百的要警惕问清钱花哪了', '/pitfalls', '社团费 会费 交钱 社团', 'pitfall-6-2');
add('刷单是骗局吗', '刷单返现日入几百全是骗局，先给小甜头等你投大钱就跑路，刷单本身违法', '/pitfalls', '刷单 返现 兼职诈骗 网络兼职 日入', 'pitfall-7-0');
add('兼职要交押金', '正规兼职绝不让你先交钱，押金服装费培训费保证金都是坑', '/pitfalls', '兼职 押金 培训费 保证金 服装费 交钱', 'pitfall-7-1');
add('怎么找靠谱兼职', '别通过不靠谱中介，走学校勤工助学或熟人介绍更稳妥，别耽误上课', '/pitfalls', '兼职 家教 勤工助学 中介 靠谱 赚钱', 'pitfall-7-2');
