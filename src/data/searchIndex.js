...
add('上门推销怎么办', '到校第一天有人推销电话卡、宽带、学习资料，别急着买，先去营业厅问清楚', '/pitfalls', '推销 电话卡 上门 宽带 骗子', 'pitfall-0-0');
...
add('课本不用买新的', '很多课不按书讲，去二手群收旧书便宜很多', '/pitfalls', '课本 教材 买书 二手 旧书', 'pitfall-1-2');
add('翘课会怎样', '现在很多课钉钉/雨课堂签到还随机点名，翘课被抓平时分扣光可能挂科', '/pitfalls', '翘课 逃课 签到 考勤 点名 挂科', 'pitfall-1-3');
add('健身卡别急着办', '开学信心满满要健身，办了年卡去了三次', '/pitfalls', '健身卡 健身 健身房 运动', 'pitfall-2-2');
add('床上桌实用吗', '看起来很好用实际占地方，腿放不下，不如去图书馆自习室', '/pitfalls', '床上桌 桌 学习', 'pitfall-2-0');
add('军训用品要买多少', '网上军训必备30件套大多用不上，防晒、鞋垫、水杯够了', '/pitfalls', '军训用品 军训必备 冰袖 袖套 囤货', 'pitfall-2-3');
add('外卖踩雷', '藏在犄角旮旯的外卖店卫生差容易吃坏肚子，点评价高销量大的店', '/pitfalls', '外卖 不干净 卫生 吃坏肚子 拉肚子', 'pitfall-3-0');
add('宿舍外放吵怎么办', '半夜外放刷视频打游戏最招人烦，戴耳机是基本教养', '/pitfalls', '外放 吵 耳机 宿舍矛盾 室友吵', 'pitfall-4-0');
add('宿舍卫生怎么搞', '垃圾没人倒容易招蟑螂老鼠还甩锅，开学就定值日表轮流来', '/pitfalls', '宿舍卫生 值日 打扫 垃圾 蟑螂', 'pitfall-4-1');
add('室友作息不一样', '有人早睡有人熬夜易冲突，商量好熄灯时间用小台灯静音键盘', '/pitfalls', '作息 熄灯 室友 早睡 熬夜 台灯', 'pitfall-4-4');
add('校园卡套餐坑', '9元无限流量卡往往限速或第二月涨价，办卡前问清合约期和到期资费', '/pitfalls', '校园卡 套餐 流量卡 电话卡 限速 涨价', 'pitfall-5-0');
add('游戏充值上头', '大学有了钱皮肤抽卡一冲动就氪金，给自己定额度别掏空钱包', '/pitfalls', '游戏 充值 氪金 皮肤 抽卡 上头', 'pitfall-5-2');
add('填问卷送手机是坑吗', '填问卷关注公众号送礼品多半套个人信息甚至办贷款，别交身份证银行卡', '/pitfalls', '填问卷 送手机 送耳机 个人信息 套路', 'pitfall-5-3');
add('军训防晒', '别觉得男生不用防晒，军训晒好几天会晒伤脱皮，买防水防晒霜勤补', '/pitfalls', '军训 防晒 晒伤 脱皮 男生', 'pitfall-6-0');
add('军训鞋磨脚', '军训鞋底硬码数不一定合适，提前备软鞋垫和创可贴', '/pitfalls', '军训 鞋 磨脚 起泡 鞋垫', 'pitfall-6-1');
add('军训会中暑吗', '每年都有人硬扛中暑晕倒，多喝水不舒服就打报告休息别逞强', '/pitfalls', '军训 中暑 晕倒 喝水 休息', 'pitfall-6-2');
add('社团要报几个', '百团大战别一口气报七八个，会费白交活动没去，挑1-2个真感兴趣的', '/pitfalls', '社团 报社团 百团大战 招新 几个', 'pitfall-7-0');
add('学生会值得进吗', '有些组织摆架子使唤新人干杂活，锻炼是真但别被当免费劳动力', '/pitfalls', '学生会 部门 组织 PUA 干杂活 新人', 'pitfall-7-1');
add('社团费要交多少', '正规社团会费就几十块，张口要一两百的要警惕问清钱花哪了', '/pitfalls', '社团费 会费 交钱 社团', 'pitfall-7-2');
add('刷单是骗局吗', '刷单返现日入几百全是骗局，先给小甜头等你投大钱就跑路，刷单本身违法', '/pitfalls', '刷单 返现 兼职诈骗 网络兼职 日入', 'pitfall-8-0');
add('兼职要交押金', '正规兼职绝不让你先交钱，押金服装费培训费保证金都是坑', '/pitfalls', '兼职 押金 培训费 保证金 服装费 交钱', 'pitfall-8-1');
add('怎么找靠谱兼职', '别通过不靠谱中介，走学校勤工助学或熟人介绍更稳妥，别耽误上课', '/pitfalls', '兼职 家教 勤工助学 中介 靠谱 赚钱', 'pitfall-8-2');

// ========== 专业解读 ==========
majorsContent.colleges.forEach((col, i) => {
  add(col.name, col.realTalk.substring(0, 80), '/majors', `${col.name} ${col.majors.join(' ')} 就业`, `major-${i}`);
  col.majors.forEach(m => add(m, `属于${col.name}类`, '/majors', m, `major-${i}`));
});
...
add('计算机专业怎么样', '邵院计算机在湖南同类院校中不错，国家级一流专业，但想好就业得自己多练', '/majors', '计算机 软件 编程 IT 程序员', 'major-0');
add('临床医学怎么样', '医学是邵院老底子，临床是省双一流学科，学医苦但好就业', '/majors', '临床 医学 学医 医生', 'major-2');
add('会计专业怎么样', '会计是国家级一流专业，考证比什么都重要', '/majors', '会计 注会 CPA 财务', 'major-1');

add('考研率高吗', '想考研的话大一开始就要重视绩点，学校也有考研自习室', '/majors', '考研 读研 保研 研究生 深造', 'major-transfer');
add('四六级什么时候考', '大一就可以考，建议尽早准备一次性过', '/majors', '四六级 英语 考证 四级 六级', 'major-3');
...
add('怎么选课', '选课前多问学长学姐，有些老师给分松有些严', '/pitfalls', '选课 抢课 教务系统 老师', 'pitfall-1-0');
