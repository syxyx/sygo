...
### 抖音内容方案大改（7/15）
- **放弃原方案**：生活费真实账单、最累专业Top5——做不出来/不靠谱
- **新方向**：纯备忘录截图（手机打字→截图→裁剪），不需要实拍照片。从"清单式攻略"转向"共鸣+有用"
- **新排期**（全图文）：
...
| 7/15 | 快递怎么收 | 3 |
| 7/16 | 报到当天5个尴尬瞬间 | 4 |
| 7/18 | 宿舍分配（唯一需网站截图的） | 待定 |
| 7/19 | 开学第一天全流程 | 4 |
| 7/20 | 新生群5种骗子 | 3 |
| 7/21 | 各专业一句话吐槽 | 3 |
| 7/22 | 新生不知道的7件事 | 5 |

- **固定操作**：标签 #邵阳学院 #邵阳学院新生 #大一新生、位置邵阳学院、发完自己补评1-2条、置顶「需要完整攻略的私信我~」
- 7条完整脚本（每张图文字+发布文案）已在本对话中写出
...
- [ ] **7/15 发快递攻略** → 7/16 发报到尴尬 → 7/18 发宿舍分配 → 7/19-22 按排期日更
