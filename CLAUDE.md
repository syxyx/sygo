...
| 7/13 | 校园照片预热 | 862 | 14 |
| 7/14 | 新生建议+问题勾子 | 842 | ~ |
| 7/16 | 新生不知道的冷知识（7件事改名） | 待观察 | 待观察 |

- 前两条均卡在800播放，原因：预热内容收藏率低（1.6%），不足以触发第二波推流，属正常
- 冷知识是第一条真正有收藏动机的内容，数据用来判断账号潜力
...
- [ ] **7/16 已发冷知识** → **7/17 不发准备草稿** → **7/18 发宿舍分配**（湖南投档首日）→ 7/19-22 按排期日更
